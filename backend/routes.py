...
# Rotas para Receitas
    ...
    @app.route('/categorias/receitas', methods=['GET'])
    ...
    @app.route('/categorias/receitas', methods=['POST'])
    ...
    @app.route('/relatorios/mensal/<int:ano>/<int:mes>', methods=['GET'])
    ...
    @app.route('/transacoes/<string:tipo>/<int:id>', methods=['DELETE'])
